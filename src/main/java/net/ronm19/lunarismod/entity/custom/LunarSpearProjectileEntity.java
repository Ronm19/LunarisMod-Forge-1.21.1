...
public class LunarSpearProjectileEntity extends AbstractArrow {
    ...
    public LunarSpearProjectileEntity( EntityType<? extends AbstractArrow> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
    }

    public LunarSpearProjectileEntity( LivingEntity shooter, Level level, ItemStack stack ) {
        super(ModEntities.LUNAR_SPEAR.get(), shooter, level, new ItemStack(ModItems.LUNAR_SPEAR.get()), null);
    }

    @Override
    protected ItemStack getDefaultPickupItem() {
        return new ItemStack(ModItems.LUNAR_SPEAR.get());
    }
    ...
    private void applyKnockback(Vec3 center) {
        ...
        for (LivingEntity target : targets) {
            ...
            target.push(force.x, 0.9, force.z);

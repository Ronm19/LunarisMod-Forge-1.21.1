...
public class ModPlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> HUSK_PLACED_KEY = registerKey("husk_placed_key");
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        ...
        register(context, HUSK_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.HUSK_ORE_KEY),
                ModOrePlacement.commonOrePlacement(5,
                        HeightRangePlacement.triangle(VerticalAnchor.absolute(-48), VerticalAnchor.absolute(20))));
